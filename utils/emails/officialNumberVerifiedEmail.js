...
function assertMailerEnv() {
  ...
  if (provider === 'smtp') {
    ...
    if (!host || !user || !pass || !from) {
      throw new Error('MAIL_PROVIDER=smtp but SMTP_HOST/SMTP_USER/SMTP_PASS/SMTP_FROM is missing');
    }
    return;
  }
...
function buildOfficialNumberVerifiedEmail(business, baseUrl) {
  ...
  const subject = '✅ Official Number Verified - Kasyora.com';
        ...
        <td class="px" style="padding:22px 26px;background:linear-gradient(135deg, ${brand.green} 0%, ${brand.blue} 100%);">
          <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
            <div style="min-width:0;">
              <div style="color:#fff;font-weight:900;font-size:16px;letter-spacing:-0.2px;">Kasyora.com</div>
